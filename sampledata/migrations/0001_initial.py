...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'sampledata', ['Book'])


    def backwards(self, orm):
        # Deleting model 'Book'
        db.delete_table(u'sampledata_book')
    ...
    models = {
        ...
        u'sampledata.book': {
            ...
            'title': ('django.db.models.fields.CharField', [], {'default': "'Unknown Title'", 'max_length': '100'}),
            'year': ('django.db.models.fields.SmallIntegerField', [], {'default': '1900', 'max_length': '4'})
        }
    }

    complete_apps = ['sampledata']